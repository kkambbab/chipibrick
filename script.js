                ...
                if (b.status === 1) {
                    if (
                        ...
                        if (score === brickRowCount * brickColumnCount) {
                            ...
                            document.querySelector("#restartScreen h1").innerHTML = "치피치피차파차파두비두비다바다바 매지컬 마이 두비두비 붐붐붐 <br> 치피치피차파차파두비두비다바다바 매지컬 마이 두비두비 붐붐붐 <br> 치피치피차파차파두비두비다바다바 매지컬 마이 두비두비 붐붐붐 <br> 치피치피차파차파두비두비다바다바 매지컬 마이 두비두비 붐붐붐 <br> 치피치피차파차파두비두비다바다바 매지컬 마이 두비두비 붐붐붐 <br> 치피치피차파차파두비두비다바다바 매지컬 마이 두비두비 붐붐붐 <br> 치피치피차파차파두비두비다바다바 매지컬 마이 두비두비 붐붐붐 <br> 치피치피차파차파두비두비다바다바 매지컬 마이 두비두비 붐붐붐 <br> 치피치피차파차파두비두비다바다바 매지컬 마이 두비두비 붐붐붐 <br> 치피치피차파차파두비두비다바다바 매지컬 마이 두비두비 붐붐붐";
                            videoA.pause();
                            videoB.pause();
                            return;
                        }
...
function initGame() {
    ...
    document.querySelector("#restartScreen h1").innerHTML = "우르륽...애옭....애앍....우르륵.....우륽....앩옭...매앍...";
